...
const I18N = {
  en: {
    ...
    "cv.studio": "Studio",
    "cv.focusLabel": "Focus",
    "cv.focusValue": "Space, interior, furniture",
    "cv.available": "Available",
    "cv.availableValue": "Internship / junior role",
    "cv.about": "About",
    "cv.aboutText": "I study architecture at UBT in Prishtinë. My work sits between the building, the room and the object — how light enters, what a material does up close, and how a space feels when you walk in.",
    "cv.aboutText2": "Beside studio courses I run ArchiMuse: a quiet place to show interiors, furniture studies and house concepts. I draw, model and also design the way the work is presented online. I am looking for a first studio role or internship where I can learn from built work.",
    "cv.education": "Education",
    "cv.eduTitle": "Bachelor of Architecture — BArch",
    "cv.eduText": "Design studios, architectural drawing, interiors, furniture studies and spatial analysis. Emphasis on concept, material and measured presentation.",
    "cv.work": "Selected work",
    "cv.w1t": "ArchiMuse studio",
    "cv.w1y": "Ongoing",
    "cv.w1": "Personal studio and web platform. I collect house, interior and furniture studies, then present them as a clear catalog — from first sketch to a finished card.",
    "cv.w2t": "Atrium House",
    "cv.w2": "A calm house organised around a light well and long garden views. Plan, section thinking and the relation between inside and courtyard.",
    "cv.w3t": "Interior & furniture studies",
    "cv.w3": "Soft living rooms, oak kitchen, courtyard villa and chair studies. Each piece is about material, proportion and a quiet everyday use.",
    "cv.study": "Study",
    "cv.approach": "How I work",
    "cv.p1": "Start from the site and the brief — not from a style first.",
    "cv.p2": "Test space with sketches, simple models and references.",
    "cv.p3": "Keep materials honest: wood, stone, linen, measured light.",
    "cv.p4": "Present the idea so a client can read it without noise.",
    "cv.skills": "Skills",
    "cv.sk1": "Architectural design",
    "cv.sk2": "Interior & furniture",
    "cv.sk3": "Spatial analysis",
    "cv.sk4": "Web (HTML / CSS / JS)",
    "cv.sk5": "UI / UX & Figma",
    "cv.sk6": "Concept sketches",
    "cv.sk7": "Hand drawing",
    "cv.sk8": "Project presentation",
    "cv.tools": "Tools",
    "cv.langs": "Languages",
  ...
  sq: {
    ...
    "cv.studio": "Studioja",
    "cv.focusLabel": "Fokusi",
    "cv.focusValue": "Hapësirë, interier, mobilje",
    "cv.available": "E disponueshme",
    "cv.availableValue": "Praktikë / rol junior",
    "cv.about": "Rreth meje",
    "cv.aboutText": "Studioj arkitekturë në UBT, Prishtinë. Puna ime qëndron midis ndërtesës, dhomës dhe objektit — si hyn drita, çfarë bën materiali nga afër, dhe si ndihet hapësira kur hyn.",
    "cv.aboutText2": "Përveç studios në shkollë, drejtoj ArchiMuse: një vend i qetë për interier, studime mobiljesh dhe koncepte shtëpish. Vizatoj, modeloj dhe e prezantoj punën edhe online. Kërkoj një rol të parë në studio ose praktikë ku të mësoj nga puna e ndërtuar.",
    "cv.education": "Shkollimi",
    "cv.eduTitle": "Bachelor i Arkitekturës — BArch",
    "cv.eduText": "Studio dizajni, vizatim arkitektonik, interier, mobilje dhe analizë hapësinore. Theks te koncepti, materiali dhe prezantimi i matur.",
    "cv.work": "Puna e zgjedhur",
    "cv.w1t": "Studio ArchiMuse",
    "cv.w1y": "Në vazhdim",
    "cv.w1": "Studio personale dhe platformë web. Mbledh studime shtëpish, interieresh dhe mobiljesh, pastaj i paraqes si katalog të qartë — nga skica te karta e përfunduar.",
    "cv.w2t": "Atrium House",
    "cv.w2": "Shtëpi e qetë e organizuar rreth një pusi drite dhe pamjeve të gjata të kopshtit. Plan, mendim në prerje dhe lidhja mes brendësisë dhe oborrit.",
    "cv.w3t": "Studime interieri & mobiljesh",
    "cv.w3": "Dhoma të buta, kuzhinë lisi, vilë me oborr dhe studime karrigesh. Secila pjesë flet për material, proporcion dhe përdorim të përditshëm.",
    "cv.study": "Studim",
    "cv.approach": "Si punoj",
    "cv.p1": "Filloj nga vendi dhe brief-i — jo nga stili i parë.",
    "cv.p2": "Provoj hapësirën me skica, modele të thjeshta dhe referenca.",
    "cv.p3": "I mbaj materialet të ndershme: dru, gur, liri, dritë e matur.",
    "cv.p4": "E prezantoj idenë që klienti ta lexojë pa zhurmë.",
    "cv.skills": "Aftësitë",
    ...
    "cv.sk7": "Vizatim me dorë",
    "cv.sk8": "Prezantim projekti",
    "cv.tools": "Mjetet",
    "cv.langs": "Gjuhët",
